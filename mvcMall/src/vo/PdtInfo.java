...
// 하나의 상품정보를 저장할 클래스
 private String pl_id, pl_orig, pl_name, pl_opt, pl_img1, pl_img2, pl_img3, pl_desc, pl_deliv, pl_view, pl_date, cb_name, cs_name;
...
public String getPl_deliv() {
	return pl_deliv;
}
public void setPl_deliv(String pl_deliv) {
	this.pl_deliv = pl_deliv;
}
