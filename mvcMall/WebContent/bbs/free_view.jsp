...
<tr><th>내용</th><td colspan="3"><%=article.getFl_content().replace("\r\n", "<br/>") %></td></tr>
...
} else if (uid != null && uid.equals(article.getFl_writer())) {// 현재 로그인한 회원과 작성자가 같으면
	isPms = true;
...
if (isPms) {	// 수정 및 삭제 권한이 있거나 비회원 글이면
	...
	// 회원이 등록한 글일경우 (현재 글이 로그인한 회원의 글이면)
%>
<script>
